    ...
    >
      <div className='w-full px-48 py-2 grid grid-cols-[1fr_min-content_1fr] gap-16'>
        ...
        <div className='flex gap-2 h-full items-center'>  
          <div className='py-2 px-6 rounded-lg text-sm hover:bg-[#f4f4f4] hover:cursor-pointer transition-all'>
            Home
          </div>
          <div className='py-2 px-6 rounded-lg text-sm hover:bg-[#f4f4f4] hover:cursor-pointer transition-all'>
            About
        ...
        <div className='flex gap-2 justify-end'>
          <div className='relative group/filter'>
            <div className='h-9 w-9 flex justify-center items-center rounded-lg border-2 border-[#f4f4f4] hover:bg-[#f4f4f4] hover:cursor-pointer transition-all relative z-20'>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M22 3H2L10 12.46V19L14 21V12.46L22 3Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
            </div>
            <div 
              className={`absolute z-10 pt-[calc(2.5rem+2px)] -top-[2px] -right-4 pointer-events-none opacity-0 scale-95 transform origin-top transition-all duration-200 ease-out ${
                visible ? 'group-hover/filter:opacity-100 group-hover/filter:scale-100 group-hover/filter:pointer-events-auto' : ''
              }`}            
            >
              <div className='max-w-96 w-max rounded-lg p-4 bg-[#f4f4f4] flex flex-col gap-2'>
                <div className="w-full flex flex-wrap flex-row-reverse gap-1">
                  ...
                  {/* <TagSelected title={"Filler Text Lorem Ipsum"}/> */}
                  <div className='group/addtag h-8 px-3 flex items-center gap-1 hover:cursor-pointer border-r-2 border-[#f4f4f4] rounded-lg hover:bg-[#e7e7e7] transition-all'>
                    <svg className='rotate-45 fill-[#a6a6a6] group-hover/addtag:fill-[#6a6a6a] transition-all' width="12" height="12" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M6.11612 6.11612C6.60427 5.62796 7.39573 5.62796 7.88388 6.11612L12 10.2322L16.1161 6.11612C16.6043 5.62796 17.3957 5.62796 17.8839 6.11612C18.372 6.60427 18.372 7.39573 17.8839 7.88388L13.7678 12L17.8839 16.1161C18.372 16.6043 18.372 17.3957 17.8839 17.8839C17.3957 18.372 16.6043 18.372 16.1161 17.8839L12 13.7678L7.88388 17.8839C7.39573 18.372 6.60427 18.372 6.11612 17.8839C5.62796 17.3957 5.62796 16.6043 6.11612 16.1161L10.2322 12L6.11612 7.88388C5.62796 7.39573 5.62796 6.60427 6.11612 6.11612Z"/></svg>
                    <p className='text-xs font-medium text-[#a6a6a6] group-hover/addtag:text-[#6a6a6a] transition-all'>Add tag</p>
                  </div>
                </div>
              </div>
            </div>
          </div>
          <div className='h-9 w-9 flex justify-center items-center rounded-lg border-2 border-[#f4f4f4] hover:bg-[#f4f4f4] hover:cursor-pointer transition-all z-20'>
